...
void WRChartScrollElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRChartScrollElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WRChartScrollElement::*)(bool );
        ...
        {
            using _t = void (WRChartScrollElement::*)(WRColor );
...
QT_INIT_METAOBJECT const QMetaObject WRChartScrollElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WRChartElement::staticMetaObject>(),
    qt_meta_stringdata_WRChartScrollElement.data,
    qt_meta_data_WRChartScrollElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRChartHScrollElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WRChartHScrollElement::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject WRChartHScrollElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WRChartScrollElement::staticMetaObject>(),
    qt_meta_stringdata_WRChartHScrollElement.data,
    qt_meta_data_WRChartHScrollElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRChartVScrollElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dockChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WRChartVScrollElement::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject WRChartVScrollElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WRChartScrollElement::staticMetaObject>(),
    qt_meta_stringdata_WRChartVScrollElement.data,
    qt_meta_data_WRChartVScrollElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
