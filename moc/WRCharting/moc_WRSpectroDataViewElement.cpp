...
void WRSpectroDataViewElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRSpectroDataViewElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WRSpectroDataViewElement::*)(WRColor );
        ...
        {
            using _t = void (WRSpectroDataViewElement::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject WRSpectroDataViewElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WRChartDataViewElement::staticMetaObject>(),
    qt_meta_stringdata_WRSpectroDataViewElement.data,
    qt_meta_data_WRSpectroDataViewElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
