...
void WRWaterfallGaugeElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRWaterfallGaugeElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WRWaterfallGaugeElement::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject WRWaterfallGaugeElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WRChartElement::staticMetaObject>(),
    qt_meta_stringdata_WRWaterfallGaugeElement.data,
    qt_meta_data_WRWaterfallGaugeElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
