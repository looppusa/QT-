...
void WROscilloLineElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WROscilloLineElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WROscilloLineElement::*)(WRColor );
        ...
        {
            using _t = void (WROscilloLineElement::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject WROscilloLineElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WROscilloGaugeElement::staticMetaObject>(),
    qt_meta_stringdata_WROscilloLineElement.data,
    qt_meta_data_WROscilloLineElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WROscilloDataPointLineElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WROscilloDataPointLineElement::*)(int );
...
QT_INIT_METAOBJECT const QMetaObject WROscilloDataPointLineElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WROscilloLineElement::staticMetaObject>(),
    qt_meta_stringdata_WROscilloDataPointLineElement.data,
    qt_meta_data_WROscilloDataPointLineElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WROscilloDataValueLineElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WROscilloDataValueLineElement::*)(double );
...
QT_INIT_METAOBJECT const QMetaObject WROscilloDataValueLineElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WROscilloLineElement::staticMetaObject>(),
    qt_meta_stringdata_WROscilloDataValueLineElement.data,
    qt_meta_data_WROscilloDataValueLineElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
