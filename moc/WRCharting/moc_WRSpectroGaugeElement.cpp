...
void WRSpectroGaugeElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRSpectroGaugeElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WRSpectroGaugeElement::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject WRSpectroGaugeElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WRChartElement::staticMetaObject>(),
    qt_meta_stringdata_WRSpectroGaugeElement.data,
    qt_meta_data_WRSpectroGaugeElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
