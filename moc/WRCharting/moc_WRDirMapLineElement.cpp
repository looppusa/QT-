...
void WRDirMapLineElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRDirMapLineElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WRDirMapLineElement::*)(WRColor );
        ...
        {
            using _t = void (WRDirMapLineElement::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject WRDirMapLineElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WRDirMapGaugeElement::staticMetaObject>(),
    qt_meta_stringdata_WRDirMapLineElement.data,
    qt_meta_data_WRDirMapLineElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRDirMapDataPointLineElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WRDirMapDataPointLineElement::*)(int );
...
QT_INIT_METAOBJECT const QMetaObject WRDirMapDataPointLineElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WRDirMapLineElement::staticMetaObject>(),
    qt_meta_stringdata_WRDirMapDataPointLineElement.data,
    qt_meta_data_WRDirMapDataPointLineElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRDirMapDataAngleLineElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WRDirMapDataAngleLineElement::*)(double );
...
QT_INIT_METAOBJECT const QMetaObject WRDirMapDataAngleLineElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WRDirMapLineElement::staticMetaObject>(),
    qt_meta_stringdata_WRDirMapDataAngleLineElement.data,
    qt_meta_data_WRDirMapDataAngleLineElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
