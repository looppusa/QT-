...
void WRDirMapDataViewElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRDirMapDataViewElement *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WRDirMapDataViewElement::*)(WRDirMapDataPalette * );
...
QT_INIT_METAOBJECT const QMetaObject WRDirMapDataViewElement::staticMetaObject = { {
    QMetaObject::SuperData::link<WRChartDataViewElement::staticMetaObject>(),
    qt_meta_stringdata_WRDirMapDataViewElement.data,
    qt_meta_data_WRDirMapDataViewElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
