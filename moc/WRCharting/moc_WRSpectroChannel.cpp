...
void WRSpectroChannel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WRSpectroChannel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WRSpectroChannel::*)(bool );
        ...
        {
            using _t = void (WRSpectroChannel::*)(WRColor );
        ...
        {
            using _t = void (WRSpectroChannel::*)(DataZoomMethod );
...
QT_INIT_METAOBJECT const QMetaObject WRSpectroChannel::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_WRSpectroChannel.data,
    qt_meta_data_WRSpectroChannel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
